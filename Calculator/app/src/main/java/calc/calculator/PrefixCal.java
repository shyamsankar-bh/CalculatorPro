...
import static calc.calculator.PN.evaluate;
 ...
 */
public class PrefixCal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prefix_cal);
...
*/
    ...
    public void onClick(View v)
    {
        switch(v.getId())
        {
            ...
            case R.id.equal:
                if(e1.length()!=0) {
                    expression = e1.getText().toString()+e2.getText().toString();
                    ;//+text;
                    e1.setText("");
                        ...
                        expression = "enter valid numbers";
                    {
                        ...
                        if (cou == couo + 1 && cou+couo-1 == spaceCount) {
                            ...
                            if (result.toString() != "Infinity"&&result.toString() != "NaN") {
                                ...
                                dbHelper.insert("PREFIX", expression + " = " + result);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.help_std) {
            HelpDialogPostPre helpDialog = new HelpDialogPostPre(PrefixCal.this);
