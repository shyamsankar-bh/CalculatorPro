...
*/
        ...
        sqrt= (Button) findViewById(R.id.percent);
        ...
        switch (v.getId()) {
            ...
            case R.id.equal:
                ...
                try {
                    ...
                    result = new ExtendedDoubleEvaluator().evaluate(expression.replaceAll(" ",""));
                    ...
                    if (!expression.equals("0.0")&&result.toString() != "Infinity"&&result.toString() != "NaN"&&result.toString() != "infinity") {
                       e2.setText(result+"");
                        dbHelper.insert("SCIENTIFIC", expression + " = " + result);
                    }
                    else if(result.toString() == "Infinity"||result.toString()=="infinity"){
                        Toast.makeText(getApplicationContext(), "Infinity",
                                Toast.LENGTH_SHORT).show();
                        dbHelper.insert("SCIENTIFIC", expression + " = " + result);
                    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.help_std) {
            HelpDialogScientific helpDialog = new HelpDialogScientific(ScientificCal.this);
